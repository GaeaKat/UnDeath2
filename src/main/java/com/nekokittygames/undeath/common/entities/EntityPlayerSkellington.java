 ...
 */
public class EntityPlayerSkellington extends EntitySkeleton implements IUndeadEntity{
    ...
    public EntityPlayerSkellington(World worldIn) {
        super(worldIn);
    ...
    public ResourceLocation getEntityID() {
        return new ResourceLocation("undeath","playerSkell");
    }
