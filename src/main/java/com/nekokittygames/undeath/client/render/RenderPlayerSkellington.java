 ...
 */
public class RenderPlayerSkellington extends RenderBiped<EntityPlayerSkellington> {

    public RenderPlayerSkellington(RenderManager rendermanagerIn) {
        ...
        layerRot.addOverlay(new ResourceLocation("undeath","textures/entities/playerskell.png"));
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityPlayerSkellington entity) {
